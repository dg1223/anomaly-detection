...
# Feature 'SESSION_USER' depends on "SM_CN" and preprocessing data also depend on this


class CnExtractor(UnaryTransformer):
    """
    CN extractor: It is based on UnaryTransformer Extract CN features from SM_USERNAME
    """
