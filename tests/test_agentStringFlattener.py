...
def test_1():
    ...
    ans_1_data = spark.read.parquet('./data/parquet_data/agentStringFlattener_tests/ans_1_df.parquet')

    df2_schema_filePath = "./data/JSON/agent_flattener_tests/ans_data_1_schema_agentflattener.json"
...
def test_2():
    df = spark.read.parquet(
        './data/parquet_data/agentStringFlattener_tests/df.parquet')
    ...
    df4_schema_filePath = "./data/JSON/agent_flattener_tests/ans_data_2_schema_agentflattener.json"
    with open(df4_schema_filePath) as json_file:
        ans_2_data_schema = json.load(json_file)

    ans_2_data_schema = pyspark.sql.types.StructType.fromJson(json.loads(ans_2_data_schema))
