class UserAgentFlattenerParser(Transformer):
  ...
  def __init__(self, entityName='SM_USERNAME', agentSizeLimit=5, windowLength = 900, windowStep = 900):
    ...
    self._setDefault(windowLength = 900, windowStep = 900, entityName = 'SM_USERNAME', agentSizeLimit=5)
  ...
  def setParams(self, entityName='SM_USERNAME', agentSizeLimit=5, windowLength = 900, windowStep = 900):
  ...
  def httpParser(self, value):
    ...
    for string in value: 
      ...
      if (len(string.split(' '))==1):
        ...
        base.append(httpagentparser.detect(string))
