...
def write_parquet_flattener_user(testDataset, expectedDataset, td_file_name, expected_df_file_name):
    ...
    expected_result_df = spark.createDataFrame(expectedDataset, schema=expected_result_user_schema)
    ...
    expected_result_df = expected_result_df.select('SM_USERNAME', 'window', 'SM_RESOURCE')
...
expected_user_one_window_10 = [
    ...
    ('User_D', {"start": "2018-02-01T00:00:00.000+0000", "end": "2018-02-01T00:15:00.000+0000"},
     ["Resource_A", "Resource_B", "Resource_C", "Resource_D", "Resource_E", "Resource_F", "Resource_G", "Resource_H", \
    ...
    ('User_B', {"start": "2018-02-01T00:00:00.000+0000", "end": "2018-02-01T00:15:00.000+0000"},
     ["Resource_A", "Resource_B", "Resource_C", "Resource_D", "Resource_E", "Resource_B", "Resource_D", "Resource_A",
      "Resource_E"]),
...
write_parquet_flattener_user(testDataset=user_one_window_case, expectedDataset=expected_user_one_window_10,
                             td_file_name='user_one_window_10.parquet', expected_df_file_name='expected_user_one_window_10.parquet')

write_parquet_flattener_user(testDataset=user_multiple_window_case, expectedDataset=expected_user_multiple_window_case,
                             td_file_name='user_multiple_window_5.parquet', expected_df_file_name='expected_user_multiple_window_5.parquet')

write_parquet_flattener_user(testDataset=user_duplicate_resources , expectedDataset=expected_user_duplicate_resources,
                             td_file_name='user_duplicate_resources.parquet', expected_df_file_name='expected_user_duplicate_resources.parquet')

write_parquet_flattener_user(testDataset=user_duplicate_rows , expectedDataset=expected_user_duplicate_rows,
                             td_file_name='user_duplicate_rows.parquet', expected_df_file_name='expected_user_duplicate_rows.parquet')

write_parquet_flattener_user(testDataset=user_based_grouping , expectedDataset=expected_user_based_grouping,
                             td_file_name='user_based_grouping.parquet', expected_df_file_name='expected_user_based_grouping.parquet')

write_parquet_flattener_user(testDataset=user_shuffled_data , expectedDataset=expected_user_shuffled_data,
                             td_file_name='user_shuffled_data.parquet', expected_df_file_name='expected_user_shuffled_data.parquet')